...
assert re.findall(r"^##\s+(.+)$", (APP / "CHANGELOG.md").read_text(encoding="utf-8"), re.M) == ["1.12.49"]
...
assert (APP / "RELEASE-1.12.49.md").is_file()
print({"ok": True, "version": "1.12.49", "distribution": "prebuilt-staged", "fairness": "owner_user"})
