...
checks = {
    "version": ('version: "1.12.48"' in config_source or 'version: "1.12.71"' in config_source)
        and 'VERSION = "1.12.71"' in server_source,
...
print({"ok": True, "checks": len(checks) + 4, "version": "1.12.71"})
