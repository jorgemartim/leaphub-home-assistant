...
checks = {
    "version": 'version: "1.12.25"' in config_source
        and 'VERSION = "1.12.25"' in server_source,
...
if failed:
    raise SystemExit("remote confirmation 1.12.25 failed:\n- " + "\n- ".join(failed))

print({"ok": True, "checks": len(checks) + 4, "version": "1.12.25"})
