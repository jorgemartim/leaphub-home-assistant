...
assert headings == ["1.12.37"], headings
...
assert (ROOT / "GITHUB-RECOVERY-1.12.37.md").is_file()
assert (ROOT / "RELEASE-1.12.37.md").is_file()
assert (APP / "RELEASE-1.12.37.md").is_file()
