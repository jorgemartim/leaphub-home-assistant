...
check(connector.ACK_FIRST_COMMANDS == {"lock", "unlock", "climate_on", "climate_off", "quick_cool", "quick_heat", "trunk_open", "trunk_close", "windshield_defrost", "seat_heat", "seat_ventilation"}, "Conjunto ACK-first divergente")
