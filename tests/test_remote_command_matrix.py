...
check(connector.ACK_FIRST_COMMANDS == {"lock", "unlock", "climate_on", "climate_off", "quick_cool", "quick_heat", "trunk_open", "trunk_close", "windows_open", "windows_close", "sunshade_open", "sunshade_close"}, "Conjunto ACK-first divergente")
