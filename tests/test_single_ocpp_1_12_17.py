...
checks = {
    "version": ('version: \"1.12.47\"' in config or 'version: \"1.12.48\"' in config) and 'VERSION = "1.12.48"' in manager,
    "privacy_version": 'PRIVACY_VERSION = "1.12.48"' in privacy,
...
print({"ok": True, "checks": len(checks), "version": "1.12.48"})
