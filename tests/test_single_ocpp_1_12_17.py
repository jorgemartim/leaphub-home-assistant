...
checks = {
    "version": 'version: "1.12.23"' in config and 'VERSION = "1.12.23"' in manager,
    "privacy_version": 'PRIVACY_VERSION = "1.12.23"' in privacy,
...
if failed:
    raise SystemExit("single OCPP 1.12.23 failed:\n- " + "\n- ".join(failed))
