...
checks = {
    "version": 'version: "1.12.29"' in config and 'VERSION = "1.12.29"' in manager,
    "privacy_version": 'PRIVACY_VERSION = "1.12.29"' in privacy,
...
print({"ok": True, "checks": len(checks), "version": "1.12.29"})
