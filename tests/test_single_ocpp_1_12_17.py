...
checks = {
    "version": 'version: "1.12.25"' in config and 'VERSION = "1.12.25"' in manager,
    "privacy_version": 'PRIVACY_VERSION = "1.12.25"' in privacy,
...
if failed:
    raise SystemExit("single OCPP 1.12.25 failed:\n- " + "\n- ".join(failed))
print({"ok": True, "checks": len(checks), "version": "1.12.25"})
