...
checks = {
    "version": 'version: "1.12.21"' in config and 'VERSION = "1.12.21"' in manager,
    "privacy_version": 'PRIVACY_VERSION = "1.12.21"' in privacy,
...
if failed:
    raise SystemExit("single OCPP 1.12.21 failed:\n- " + "\n- ".join(failed))
