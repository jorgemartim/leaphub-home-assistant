...
checks = {
    "version": 'version: "1.12.22"' in config and 'VERSION = "1.12.22"' in manager,
    "privacy_version": 'PRIVACY_VERSION = "1.12.22"' in privacy,
...
if failed:
    raise SystemExit("single OCPP 1.12.22 failed:\n- " + "\n- ".join(failed))
