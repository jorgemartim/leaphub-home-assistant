...
O circuit breaker global não volta mais a `healthy` por dois sucessos consecutivos da mesma conta. A recuperação antecipada exige 30 segundos sem novas falhas e sucesso de duas contas distintas. Se houver somente uma conta, o período degradado expira normalmente; comandos manuais nunca são bloqueados.
