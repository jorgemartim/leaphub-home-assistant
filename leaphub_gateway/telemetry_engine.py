...
class TelemetryEngine:
    ...
    def __init__(
        ...
        # 1.12.33 — o estado essencial é FAST; mensagens/imagem oficial são SLOW.
        ...
        # 1.12.33 — a telemetria já aceita hints de um futuro transporte por
    ...
    def _poll_subscription(self, subscription: sqlite3.Row) -> None:
        ...
        # 1.12.33 — circuit breaker global: durante uma oscilação confirmada
